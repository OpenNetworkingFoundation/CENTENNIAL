...
import FileTransfer.CollectLogs;
import gui.MainView;
...
public class ParallelRestCall {
	...
	public ParallelRestCall(String taskid)
	{
		this.taskid = taskid;
	}		
	...
	public void performActions()
	{
	    ...
	    int number = 0;
	    ParallelThread.executionStack.put(taskid, 0);
	    while(iterTestSuites.hasNext())
	    {
	    	...
	    	ParallelThread newThread = new ParallelThread(taskid,urlTObeSent,newfile,number,testSuite.Details,testSuite.testSuite,testSuite.testSuite);
	    	newThread.start();	    	
	    	number++;
	    }	    
	   /* while(((int)ParallelThread.executionStack.get(taskid)) == (number-1))
	    {*/	    
